...
Let's run functions to understand them better!
</div>
...
<div class="text-3xl font-bold mt-10 ml-4">
Go to <code>mathematical-mappings/</code> directory
</div>
...
<div class="text-3xl font-bold mt-10 ml-4">
Run <code>explore-mappings-as-functions.ipynb</code>
</div>
...
<div class="text-7xl text-orange-600 font-bold mt-5 ml-4 mb-4">
Let's use dictionaries to understand them better!
</div>
...
<div class="text-7xl text-orange-600 font-bold mt-5 ml-4 mb-4">
Let's explore the use of memoization in Python!
</div>
