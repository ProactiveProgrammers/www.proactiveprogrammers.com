...
<div class="cards">
  ...
  <b><a href = "proactive-learning/introduction-proactive-learning/">Proactive Learning</a></b>

  <p class="tightcard">

    After reviewing a strategy for how you can proactively learn to program,
    review the types of assignments that this site features.

  </p>

  </div>

  <!-- Data abstraction DISCRETE STRUCTURES -->
  <div class="card">
