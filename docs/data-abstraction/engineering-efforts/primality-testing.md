...
`lint`. If you are in the `primality` directory that contains the `pyproject.toml`
...
primality tests` and it will automatically reformat the source code.
...
comments to `test_primality.py` to show that you understand how the tests work?
